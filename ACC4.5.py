...
sensors = ['28-01143b962caa', '28-01143b9d88aa'];          #Array mit den Sensor-IDs
...
Dateiname = "/home/pi/TGZ/"+timestr+".txt"
...
def Input():
    #header = input("Bitte Header Info eingeben:")
    #Pa = input("aktueller Luftdruck? ")
    #Ta = input("aktuelle Temperatur? ")
    #Dt = input("Zeit Datenspeicherung in Minuten? ")

    header = ("ACC4.5.py started at: " +timestr + '\n' + '\n' + "Zeit ," + "t[h] ," + "BME_temp ,"  + "BEM_pressure ," + "BME_humidity ," + "T1 ," + "T2 ," + "A0 ," + "A1 ," + "A2 ," + "Vg ," + "CPU_temp, " '\n')
...
def bme():
    ...
    bme_pressure = str(round((data.pressure - 1), 0))
